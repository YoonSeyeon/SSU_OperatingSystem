...
asmlinkage int sys_basic_add(int, int, int *);
asmlinkage int sys_basic_sub(int, int, int *);
asmlinkage int sys_basic_mul(int, int, int *);
asmlinkage int sys_basic_mod(int, int, int *);
